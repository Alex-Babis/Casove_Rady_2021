...
```{r}
Empl.exp.ind.sk<- read.table("https://alex-babis.github.io/Casove_Rady_2022/Employment_expectations_indicator_2002_SK.txt")
```
...
```{r}
Empl.exp.ind.hu<- read.table("https://alex-babis.github.io/Casove_Rady_2022/Employment_expectations_indicator_2002_HU.txt")
```
...
```{r}
con.conf.ind.sk<- read.table("https://alex-babis.github.io/Casove_Rady_2022/Consumer_confidence_indicator_1999_SK.txt")
```
...
```{r}
fin.sit.sk<- read.table("https://alex-babis.github.io/Casove_Rady_2022/Financial_situation_household_2003_SK.txt")
```

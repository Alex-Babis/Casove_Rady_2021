...
Z premennej `spread` vytvoríme object typu time-series, ktorý bude obsahovať informáciu o časovej štruktúre dát, podobne ako na cvičení 1.
...
```{r, eval=FALSE}
spread <- ts(data = ,             # data su premennej spread
...
```{r fig.align="center"}
autoplot(acf(spread, plot = FALSE)) 
#acf1(spread)
```

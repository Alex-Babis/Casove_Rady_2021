...
* Každá skupina si musí stiahne dáta o výmenných kurzoch, vyberie si jeden, ktorý si rezervuje. Dáta stiahnete na https://www.ecb.europa.eu/stats/policy_and_exchange_rates/euro_reference_exchange_rates/html/index.en.html dole na stránke. Time series - CSV(.zip). Môžete použiť kód na ich úpravu ako je na cvičení. 
